...
const StatementCard: React.FC<{
  ...
  <CardFrame a={a} b={b}>
    ...
    <ClayCard x={540} y={615} w={940} bg="#FFFFFF" delay={6} float={6} pad="28px 40px" radius={46}>
...
export const Hard: React.FC = () => (
  <CardFrame a={LAV} b={BLUE}>
    <Pill x={540} y={290} text="하지만," color={LAV} delay={2} />
    <div style={{ ...centerText(455, 144, CORAL), textShadow: "3px 6px 0 rgba(120,110,160,0.12)" }}>힘들 때</div>
    <div style={{ ...centerText(685, 50, "#5b5570", BODY), fontWeight: 900 }}>상황이 나빠지면…</div>
    <Mascot x={540} y={1070} w={330} delay={6} floatAmp={15} />
...
export const Real: React.FC = () => (
  <StatementCard
    ...
    big="진짜가 드러난다"
    bigColor={CORAL}
    detail={<>누가 곁에 남고<br />누가 떠나는지 보인다</>}
    tags={[{ t: "진심", c: CORAL }, { t: "태도", c: BLUE }, { t: "신뢰", c: MINT }]}
    a={CORAL}
    b={YELLOW}
  />
);
...
export const PersonVideo: React.FC = () => (
  <AbsoluteFill style={{ background: "#F3EEFB" }}>
    <Sequence from={0} durationInFrames={110}><Fade d={110}><Cover /></Fade></Sequence>
    <Sequence from={95} durationInFrames={110}><Fade d={110}><Good /></Fade></Sequence>
    <Sequence from={190} durationInFrames={110}><Fade d={110}><Hard /></Fade></Sequence>
    <Sequence from={285} durationInFrames={110}><Fade d={110}><Real /></Fade></Sequence>
