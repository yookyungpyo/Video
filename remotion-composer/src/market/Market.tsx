...
export const Reality: React.FC = () => (
  <CardFrame a={LAV} b={BLUE}>
    <Pill x={540} y={295} text="하지만," color={LAV} delay={2} />
    <div style={{ ...centerText(455, 150, CORAL), textShadow: "3px 6px 0 rgba(120,110,160,0.12)" }}>현실은?</div>
    <div style={{ ...centerText(690, 50, "#5b5570", BODY), fontWeight: 900 }}>만드는 건 쉬워졌지만…</div>
...
export const Chosen: React.FC = () => (
  <StatementCard
    ...
    big="선택받지 못한다"
    bigColor={CORAL}
    detail={<>쉽게 만든 만큼<br />시장에선 조용히 묻힌다</>}
    tags={[{ t: "포화", c: CORAL }, { t: "무관심", c: BLUE }, { t: "묻힘", c: LAV }]}
    a={CORAL}
    b={YELLOW}
  />
);

export const Density: React.FC = () => (
  <StatementCard
    icon="grid"
    lead="파이는 그대로인데"
    big="선택지만 많아졌다"
    bigColor={BLUE}
    detail={<>고객에게 닿는 선택지는 폭증<br />경쟁의 밀도가 팍팍하다</>}
    tags={[{ t: "레드오션", c: BLUE }, { t: "선택 피로", c: YELLOW }, { t: "포화", c: MINT }]}
    a={BLUE}
    b={MINT}
  />
);
...
export const Closing: React.FC = () => (
  <CardFrame a={MINT} b={BLUE}>
    <Pill x={540} y={290} text="그래서," color={LAV} delay={2} />
    <div style={{ ...centerText(420, 74, INK) }}>우린 무얼</div>
