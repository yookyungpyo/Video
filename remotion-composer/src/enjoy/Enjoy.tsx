...
const Scene1: React.FC<{ start: number; dur: number }> = ({ start, dur }) => {
  ...
  return (
    <AbsoluteFill>
      <PhotoBG src={staticFile("enjoy/s1.jpg")} progress={progress} zoom="in" panY={-4} scrim="both" />
...
const Scene2: React.FC<{ start: number; dur: number }> = ({ start, dur }) => {
  ...
  return (
    <AbsoluteFill>
      <PhotoBG src={staticFile("enjoy/s2.jpg")} progress={progress} zoom="out" panX={3} scrim="both" />
      <AbsoluteFill style={{ alignItems: "flex-start", justifyContent: "flex-start", padding: "150px 90px" }}>
        ...
        >
          재미가<br />
          <span style={{ color: RED }}>사라진다</span>
        </div>
      </AbsoluteFill>
    </AbsoluteFill>
  );
...
const Scene3: React.FC<{ start: number; dur: number }> = ({ start, dur }) => {
  ...
  return (
    <AbsoluteFill>
      <PhotoBG src={staticFile("enjoy/s3.jpg")} progress={progress} zoom="in" panX={-3} scrim="heavy" />
      <AbsoluteFill style={{ alignItems: "center", justifyContent: "center", padding: "0 70px" }}>
        ...
        >
          미친 듯이 <span style={{ color: "rgba(255,255,255,0.55)" }}>즐겨</span>
        </div>
        <div
          style={{
            ...headlineStyle,
        ...
        >
          그게 <span style={{ color: AMBER }}>진짜다</span>
        </div>
        <div
          style={{
            marginTop: 40,
            padding: "20px 34px",
            borderRadius: 22,
            background: "rgba(245,181,68,0.94)",
            boxShadow: "0 14px 32px rgba(0,0,0,0.4)",
            opacity: t3,
            transform: `translateY(${(1 - t3) * 24}px) scale(${0.9 + t3 * 0.1}) rotate(${(1 - t3) * -3}deg)`,
          }}
        >
          <div style={{ fontFamily: DISPLAY, fontSize: 60, color: "#0A0F1C", textAlign: "center", lineHeight: 1.15 }}>
            잘하는 것보다
            <br />
            <span style={{ fontSize: 78 }}>오래 간다</span>
          </div>
        </div>
      </AbsoluteFill>
...
const Scene4: React.FC<{ start: number; dur: number }> = ({ start, dur }) => {
  ...
  return (
    <AbsoluteFill>
      <PhotoBG src={staticFile("enjoy/s4.jpg")} progress={progress} zoom="in" panY={-3} scrim="heavy" />
      <AbsoluteFill style={{ alignItems: "center", justifyContent: "center", padding: "0 80px" }}>
        ...
        >
          <span style={{ color: AMBER }}>더 멀리 간다</span>
        </div>
      </AbsoluteFill>
...
const Scene5: React.FC<{ start: number; dur: number }> = ({ start, dur }) => {
  ...
  return (
    <AbsoluteFill>
      <PhotoBG src={staticFile("enjoy/s5.jpg")} progress={progress} zoom="out" panY={3} scrim="both" />
      <AbsoluteFill style={{ alignItems: "center", justifyContent: "flex-start", paddingTop: 200 }}>
        ...
        >
          그냥 <span style={{ color: AMBER }}>즐겨라</span>
        </div>
      </AbsoluteFill>
