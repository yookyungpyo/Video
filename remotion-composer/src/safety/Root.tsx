...
import { Cover, Define, Versus, Result, Closing, SafetyVideo } from "./Safety";
...
export const Root: React.FC = () => (
  <>
    ...
    <Composition id="SafetyVideo" component={SafetyVideo} durationInFrames={550} fps={FPS} width={W} height={H} />
  </>
);
