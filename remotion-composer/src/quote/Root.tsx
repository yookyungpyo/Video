...
import { QuoteA, QuoteB, QuoteC, QuoteD, QuoteE, QuoteR, QuoteG, QuoteReel, REEL_TOTAL, MindReel, MIND_TOTAL, StoryReel, STORY_TOTAL } from "./Quote";
...
export const Root: React.FC = () => (
  <>
    ...
    <Composition id="StoryReel" component={StoryReel} fps={FPS} width={1080} height={1920} durationInFrames={STORY_TOTAL} />
  </>
);
