#!/usr/bin/env bash
# Light collage soundtrack for the "EnjoyCollage" video (~20.2s, 30fps), all
...
ffmpeg -y -v error -stream_loop 9 -i "$AD/bar.wav" -t 20.2 -af "lowpass=f=9000,volume=0.30" "$AD/beat.wav"

# event-synced placement: "file delay_ms volume"
# cut boundaries (ms): 0, 3170, 6500, 9830, 13500, 16830
rows=(
 "beat 0 0.26"
 "paper 60 0.34" "paper 3170 0.32" "paper 6500 0.32" "paper 9830 0.36" "paper 13500 0.32" "paper 16830 0.32"
 "stamp 300 0.42" "stamp 480 0.42" "stamp 660 0.42"
 "stamp 3430 0.46" "stamp 6760 0.44" "stamp 7030 0.40"
 "stamp 10100 0.46" "stamp 10380 0.54"
 "stamp 13770 0.46" "stamp 17100 0.44" "stamp 17370 0.50"
 "chime 10380 0.30" "chime 10840 0.26" "chime 11100 0.22" "chime 17380 0.30"
 "tick 4040 0.17" "tick 4200 0.17" "tick 4360 0.17"
 "tick 7440 0.17" "tick 7600 0.17" "tick 7760 0.17"
 "tick 14440 0.17" "tick 14600 0.17" "tick 14760 0.17"
)
inp=""; fc=""; lab=""; n=${#rows[@]}
...
fc+="[mx]volume=3.0,acompressor=threshold=-20dB:ratio=3:attack=12:release=180,alimiter=limit=0.96,lowpass=f=16000,afade=t=out:st=19.6:d=0.5,atrim=0:20.2,aformat=channel_layouts=stereo[out]"
