...
set -euo pipefail
IN="${1:-../projects/cardnews/priority-collage.mp4}"
OUT="${2:-../projects/cardnews/priority-collage-sound.mp4}"
...
# event-synced placement: "file delay_ms volume" (coins replaced by checklist/close ticks)
rows=(
 "beat 0 0.26"
 ...
 "tick 950 0.20" "tick 1060 0.20" "tick 1170 0.20" "tick 1280 0.20"
 ...
 "tick 14530 0.18" "tick 14730 0.18" "tick 14930 0.18"
)
inp=""; fc=""; lab=""; n=${#rows[@]}
